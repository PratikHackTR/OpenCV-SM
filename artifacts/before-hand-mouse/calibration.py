...
STEPS = [
    ...
    ("aim", "3 / 5 · İki elle nişan", "İki elini birbirinden ayır. Kameraya doğru, rahat göğüs/karın hizanda iki ağ işareti yap. İki el de tamamen görünsün."),
    ("open", "4 / 5 · Açık el", "İki avucunu nişan yüksekliğinde aç; dört parmağın da açık olsun. Bu örnek E hareketini ayırır."),
